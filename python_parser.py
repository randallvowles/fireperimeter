...
def parser(response):
    ...
    # url = "https://www.geomac.gov/asp-bin/GeoMACKML/kmlHelper.htm?http://rmgsc.cr.usgs.gov/outgoing/GeoMAC/current_year_fire_data/KMLS/TNGSP-016062%20CHIMNEY%20TOPS%202%2011-30-2016%202126.kml"
